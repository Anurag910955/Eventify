...
const NotFound = () => {
  return (
    <div className="w-screen min-h-screen flex flex-col items-center justify-center bg-gray-100 text-center px-4 py-12">
      <h1 className="text-6xl sm:text-7xl font-extrabold text-blue-600">404</h1>
