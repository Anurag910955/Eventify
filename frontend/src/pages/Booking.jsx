...
const Booking = () => {
  ...
  const handleSendOtp = async () => {
    setSendingOtp(true);
    try {
      const res = await fetch("https://eventify-7v8x.onrender.com/api/verify-email/send-otp", {
        method: "POST",
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const res = await fetch("https://eventify-7v8x.onrender.com/api/verify-email/confirm-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handlePayment = async () => {
    try {
      const res = await fetch("https://eventify-7v8x.onrender.com/api/payment/create-order", {
        method: "POST",
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://eventify-7v8x.onrender.com/api/bookings", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
