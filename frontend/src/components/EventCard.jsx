...
const EventCard = ({ event }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 overflow-hidden group w-full sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto">
      {/* Event Image */}
      ...
      <div className="p-5 space-y-2">
        <h3 className="text-xl sm:text-2xl font-bold text-blue-700 leading-snug">
